...
// the very last parameter means that we have two permutations. so the first half of the Lineshapes 
  ...
  //RS Model
   Amplitude* AMP_K1P2Kstar1430       = new Amplitude( "K1P2Kstar1430",   new Variable("K1P2Kstar1430_real", 0.880786 ),     new Variable("K1P2Kstar1430_imag",  0.186401  ), LSK1P2Kstar1430, SFK1P2Kstar1430, 1);

  Amplitude* AMP_K1M2Kstar1430       = new Amplitude( "K1M2Kstar1430",   new Variable("K1M2Kstar1430_real", 0.901429 ),   new Variable("K1M2Kstar1430_imag", 0.345775  ), LSK1M2Kstar1430, SFK1M2Kstar1430 , 1);

 Amplitude* AMP_K1P2Kstar       = new Amplitude( "K1P2Kstar",   new Variable("K1P2Kstar_real", 0.216362),     new Variable("K1P2Kstar_imag", 0.226092  ), LSK1P2Kstar, SFK1P2Kstar, 1);

  Amplitude* AMP_K1M2Kstar       = new Amplitude( "K1M2Kstar",   new Variable("K1M2Kstar_real", 0.215030 ),   new Variable("K1M2Kstar_imag", 0.295306  ), LSK1M2Kstar, SFK1M2Kstar , 1);

  Amplitude* AMP_K1P2Rho       = new Amplitude( "K1P2Rho",   new Variable("K1P2Rho_real", 0.445008  ), new Variable("K1P2Rho_imag", 0.766500  ), LSK1P2Rho, SFK1P2Rho, 1);

  Amplitude* AMP_K1M2Rho      = new Amplitude( "K1M2Rho",    new Variable("K1M2Rho_real", 0.430987 ),  new Variable("K1M2Rho_imag", 0.655218  ), LSK1M2Rho, SFK1M2Rho, 1);
  
  Amplitude* AMP_KstarP2Kstar         = new Amplitude( "KstarP2Kstar",      new Variable("KstarP2Kstar_real", 0.477727  ),  new Variable("KstarP2Kstar_imag", -0.209353  ), LSKstarP2Kstar, SFKstarP2Kstar, 1);
 
 Amplitude* AMP_KstarM2Kstar     = new Amplitude( "KstarM2Kstar", new Variable("KstarM2Kstar_real", 0.419183 ),   new Variable("KstarM2Kstar_imag",-0.0541111 ), LSKstarM2Kstar  , SFKstarM2Kstar , 1);
   
 Amplitude* AMP_KstarKstarbarS          = new Amplitude( "KstarKstarbarS",      new Variable("KstarKstarbarS_real", -0.0674667 ),  new Variable("KstarKstarbarS_imag", -0.265135  ), LSKstarKstarbarS  , SFKstarKstarS , 1);
 

 Amplitude* AMP_KstarKstarbarP          = new Amplitude( "KstarKstarbarP",      new Variable("KstarKstarbarP_real", 0.126282),  new Variable("KstarKstarbarP_imag", -0.220891  ), LSKstarKstarbarP  , SFKstarKstarP , 1);
 

 Amplitude* AMP_KstarKstarbarD          = new Amplitude( "KstarKstarbarD",      new Variable("KstarKstarbarD_real", -0.062616),  new Variable("KstarKstarbarD_imag", -3.39321  ), LSKstarKstarbarD  , SFKstarKstarD , 1);
 ...
 Amplitude* AMP_PhiRhoP       = new Amplitude( "PhiRhoP",   new Variable("PhiRhoP_real", -0.0591935 ),  new Variable("PhiRhoP_imag", 0.575180  ), LSPhiRhoP  , SFPhiRhoP , 1);

  Amplitude* AMP_PhiRhoD        = new Amplitude( "PhiRhoD",    new Variable("PhiRhoD", 13.8201  ),   new Variable("PhiRhoD_imag", 1.14047  ), LSPhiRhoD  , SFPhiRhoD , 1);
 
  Amplitude* AMP_PhiFZero        = new Amplitude( "PhiFZero",    new Variable("PhiFZero",1.82792   ),   new Variable("PhiFZero_imag", 2.94016  ), LSPhiRhoD  , SFPhiRhoD , 1);
