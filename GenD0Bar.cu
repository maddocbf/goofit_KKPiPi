...
// the very last parameter means that we have two permutations. so the first half of the Lineshapes 
  ...
  //RS Model
   Amplitude* AMP_K1P2Kstar1430       = new Amplitude( "K1P2Kstar1430",   new Variable("K1P2Kstar1430_real", 0.816033 ),     new Variable("K1P2Kstar1430_imag",  0.428719  ), LSK1P2Kstar1430, SFK1P2Kstar1430, 1);
